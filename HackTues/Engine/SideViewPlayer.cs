...
public class SideViewPlayer: Player {
    ...
    public override Vector2 CameraPos => new Vector2(1440, 900) / 128;
    protected override Vector2 Friction { get; } = new(0.00001f, 0.1f);
